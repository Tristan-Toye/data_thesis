#!/bin/bash
# Recording script for: behavior_path_planner
...
echo "Recording node: behavior_path_planner"
echo "Package: behavior_path_planner"
echo "Executable: behavior_path_planner_node"
...
python3 recorder.py "behavior_path_planner" "behavior_path_planner_node" "/autoware" "behavior_path_planner" "${REMAP_FILE}"

echo ""
echo "Recording complete for behavior_path_planner"
